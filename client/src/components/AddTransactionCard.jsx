          ...
          <div className="flex flex-row justify-between items-centerrounded-xl mt-5">
            {!loading ? (
              <button
                ...
                className="flex flex-row justify-center items-center w-full text-white text-lg bg-black py-2 px-5 rounded-xl drop-shadow-xl border border-transparent hover:text-aqua focus:outline-none focus:ring"
              >
                Send Money
              </button>
            ) : (
              <button
                className="flex flex-row justify-center items-center w-full text-white text-lg bg-black py-2 px-5 rounded-xl drop-shadow-xl border border-transparent focus:outline-none focus:ring"
                disabled
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
